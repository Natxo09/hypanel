...
**Download:** [hytale-downloader.zip](https://hytale.com/downloader) (Linux & Windows)
...
> **Security Warning:** The payload is transmitted through the client and can be tampered with. Sign payloads cryptographically (e.g., HMAC with a shared secret) so the receiving server can verify authenticity.
